...
namespace bank_sys
{
    public partial class addbranch : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand myCommand = new SqlCommand("insert into Branch (branch_num,ADDRESS,Code) values ('" + textBox1.Text.ToString() + "','" + textBox2.Text.ToString() + "' ,'" + textBox3.Text.ToString() + "')", con);
